...
<img src="../_static/media/chapter_1/section_4/media/image6.jpeg" class="common_img" />

<img src="../_static/media/chapter_1/section_4/media/image7.jpeg" class="common_img" />

<img src="../_static/media/chapter_1/section_4/media/image8.jpeg" class="common_img" />

Interface indication:

<img src="../_static/media/chapter_1/section_4/media/image9.jpeg" class="common_img" />
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image2.png"  />

(2) The "**Execute File**" dialog box will appear. Click "**Execute**" to proceed.

<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image3.png"  />

(3) After entering the software, you can see the interface of LAB_Tool, as shown in the figure below:

<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image4.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image5.png"  />
...
<tr>
<td ><img  src="../_static/media/chapter_8/9.2/media/image6.png"  /></td>
...
<tr>
<td ><img  src="../_static/media/chapter_8/9.2/media/image7.png"  /></td>
<td >Choose color to adjust the threshold.</td>
</tr>
<tr>
<td ><img  src="../_static/media/chapter_8/9.2/media/image8.png"  /></td>
<td >Delete the currently selected color.</td>
</tr>
<tr>
<td ><img  src="../_static/media/chapter_8/9.2/media/image9.png"  /></td>
<td >Add recognizable color.</td>
</tr>
<tr>
<td ><img  src="../_static/media/chapter_8/9.2/media/image10.png"  /></td>
<td >Save the adjustment result of the color threshold.</td>
</tr>
<tr>
<td ><img  src="../_static/media/chapter_8/9.2/media/image11.png"  /></td>
<td >Click this button to switch between Chinese and English.</td>
</tr>
<tr>
<td ><img  src="../_static/media/chapter_8/9.2/media/image12.png"  /></td>
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image14.png"  />

(2) Adjust the "**min**" values of L, A and B components to "**0**", and the "**max**" values to "**225**".

<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image15.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image16.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image17.png"  />

<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image18.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image19.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image20.png" style="width:300px" />
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image21.png"  style="width:150px"  />

(2) Fill in the "**name**" column with the color name, and click the "**OK**" button.

<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image22.png"  />

(3) Choose the added color in the color drop-down menu.

<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image23.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image24.png"  />

<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image25.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.2/media/image26.png"  />
...
(2) Click on <img src="../_static/media/chapter_8/9.3/media/image2.png"  /> to open the command line terminal.
...
Click <img   src="../_static/media/chapter_8/9.3/media/image7.png"   /> and enter the command. Press enter to start the app, and wait for the buzzer to beep. Please enter the command in the system path, not in the Docker container.
...
<img  class="common_img" src="../_static/media/chapter_8/9.3/media/1.png"   />

<img  class="common_img" src="../_static/media/chapter_8/9.3/media/2.png"   />

<img  class="common_img" src="../_static/media/chapter_8/9.3/media/3.png"   />
...
<img  class="common_img" src="../_static/media/chapter_8/9.3/media/image10.png"   />
...
(2) Click on <img src="../_static/media/chapter_8/9.4/media/image2.png"  /> to open the command line terminal.
...
Click <img src="../_static/media/chapter_8/9.4/media/image7.png"  /> and enter the command. Press enter to start the app, and wait for the buzzer to beep.
...
<img  class="common_img" src="../_static/media/chapter_8/9.4/media/image9.png"  />

(2) Press "**Enter**" to display a QR code image containing the input data.

<img  class="common_img" src="../_static/media/chapter_8/9.4/media/image10.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.4/media/image11.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.4/media/image17.png"  />
...
<img  class="common_img" src="../_static/media/chapter_8/9.5/media/image10.png"  style="width:600px" />
...
<img  class="common_img" src="../_static/media/chapter_8/9.5/media/image11.png"   />
...
<img  class="common_img" src="../_static/media/chapter_8/9.5/media/image14.png"  />
...
(2) Click on <img src="../_static/media/chapter_8/9.6/media/image3.png"  /> on the system desktop to open the command line terminal.
...
<img  class="common_img" src="../_static/media/chapter_8/9.6/media/image8.png"   />
...
(2) Click-on <img   src="../_static/media/chapter_8/9.7/media/image2.png"  /> to launch the command-line terminal.
...
<img  class="common_img" src="../_static/media/chapter_8/9.7/media/image4.png"   />

(5) Click <img src="../_static/media/chapter_8/9.7/media/image5.png"  /> to open a new terminal, then enter the following command to launch the camera. Once the live camera feed appears, click on the target area to select and capture its color.
...
(8) Click <img   src="../_static/media/chapter_8/9.3/media/image7.png"   />and enter the command. Press enter to start the app, and wait for the buzzer to beep. Please enter the command in the system path, not in the Docker container.
...
<img  class="common_img" src="../_static/media/chapter_8/9.7/media/image10.png" style="width:5.76389in;height:3.87014in" />
