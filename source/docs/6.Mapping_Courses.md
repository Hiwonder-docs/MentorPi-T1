...
<img src="../_static/media/chapter_6/section_1/01/media/image15.png" class="common_img" />
...
(2) Click-on <img src="../_static/media/chapter_6/section_2/01/media/image2.png"  /> to create a command-line terminal.
...
Click <img src="../_static/media/chapter_6/section_2/01/media/image8.png" /> and enter the command. Press enter to start the app, and wait for the buzzer to beep.
...
<img src="../_static/media/chapter_6/section_3/01/media/image2.jpeg" class="common_img" />
...
(2) Click on <img src="../_static/media/chapter_6/section_4/01/media/image4.png"   /> to open the virtual machine.

(3) Enter the  `virtual machine interface` and click on `“Open Virtual Machine”`.

<img src="../_static/media/chapter_6/section_4/01/media/image5.png" class="common_img" />
...
② Click-on <img src="../_static/media/chapter_6/section_4/01/media/image6.png"  /> to open the `ROS2 command-line terminal`.
...
⑩ Click-on <img src="../_static/media/chapter_6/section_4/01/media/image14.png" /> to open the file directory, then navigate to the `home/pi/docker/tmp` directory:

<img src="../_static/media/chapter_6/section_4/01/media/image15.png" class="common_img" />

⑪ Use the shortcut `‘Ctrl + H’` to show the hidden `.typerc` file:

<img src="../_static/media/chapter_6/section_4/01/media/image16.png" class="common_img" />

⑫ Refer to the instruction in [6.6 Install WinSCP](#66-install-winscp) to install and open the `WinSCP` tool.

<img src="../_static/media/chapter_6/section_4/01/media/image17.png" class="common_img" />

⑬ Enter the `IP address` of `Raspberry Pi` `“192.168.149.1”`, `username` `“pi”`, and `password` `“raspberrypi”`. Then click `“Login”`.

<img src="../_static/media/chapter_6/section_4/01/media/image18.png" class="common_img" />

⑭ Click `“Accept”` on the pop-up window that appears.

<img src="../_static/media/chapter_6/section_4/01/media/image19.png" class="common_img" />

⑮ The left side shows the directory of your computer, and the right side shows the `root directory` of `Raspberry Pi`.

<img src="../_static/media/chapter_6/section_4/01/media/image20.png" class="common_img" />

⑯ Select the folder `“docker->tmp”` and open the `shared folder` with `Docker`.

<img src="../_static/media/chapter_6/section_4/01/media/image21.png" class="common_img" />
...
<img src="../_static/media/chapter_6/section_4/01/media/image22.png" class="common_img" />
...
① Click-on <img src="../_static/media/chapter_6/section_4/01/media/image25.png"  /> to navigate to the home directory.
...
(1) Click-on <img src="../_static/media/chapter_6/section_4/01/media/image28.png"  /> to start the virtual machine command-line terminal.
...
<img src="../_static/media/chapter_6/section_4/01/media/image37.jpeg" class="common_img" />
...
(1) Click-on <img src="../_static/media/chapter_6/section_4/01/media/image40.png"  /> to open the command line terminal.
...
<img src="../_static/media/chapter_6/section_4/01/media/image42.png" class="common_img" />
...
<img src="../_static/media/chapter_6/section_4/01/media/image43.png" class="common_img" />
...
<img src="../_static/media/chapter_12/section_1/01/media/image17.png" class="common_img" style="width:700px;"/>
...
<img src="../_static/media/chapter_6/section_4/01/media/image47.png" class="common_img" />

② `Robot`:

<img src="../_static/media/chapter_6/section_4/01/media/image48.png" class="common_img" />

(8) After rebooting, click on <img src="../_static/media/chapter_6/section_4/01/media/image6.png"  /> to open the robot's `ROS2 command line terminal`. You will notice that the `ROS_DOMAIN_ID` is `0`, which is the same as on the `virtual machine`.

① `Robot`:

<img src="../_static/media/chapter_6/section_4/01/media/image49.png" class="common_img" />

② `Virtual Machine`:

<img src="../_static/media/chapter_6/section_4/01/media/image50.png" class="common_img" />

### 6.4.3 slam Mapping Instructions

* **Robot operations**

(1) Click-on <img src="../_static/media/chapter_6/section_4/01/media/image6.png"   /> to open the command-line terminal.
...
(1) Click-on <img src="../_static/media/chapter_6/section_4/01/media/image53.jpeg"   /> to open the command line terminal of the `virtual machine system`.
...
<img src="../_static/media/chapter_6/section_4/01/media/image55.png" class="common_img" />
...
<img src="../_static/media/chapter_6/section_4/01/media/image57.png" class="common_img" />
...
Click <img src="../_static/media/chapter_6/section_4/01/media/image59.png"  /> and enter the command. Press enter to start the app, and wait for the buzzer to beep.
...
<img src="../_static/media/chapter_6/section_4/01/media/image61.png" class="common_img" />
...
<img src="../_static/media/chapter_6/section_5/01/media/image2.png" class="common_img" />
...
(1) Click on <img src="../_static/media/chapter_6/section_5/01/media/image3.png" /> on the system desktop to open the command-line terminal.
...
(1) Click-on <img src="../_static/media/chapter_6/section_5/01/media/image6.png"   /> to open the command-line terminal.
...
<img src="../_static/media/chapter_6/section_5/01/media/image8.png" class="common_img" />

* **Enable Keyboard Control**

(1) Click-on <img src="../_static/media/chapter_6/section_5/01/media/image3.png"  /> to open the command-line terminal.
...
<img src="../_static/media/chapter_6/section_5/01/media/image10.png" class="common_img" />
...
Click <img src="../_static/media/chapter_6/section_5/01/media/image11.png"   /> and enter the command. Press enter to start the app, and wait for the buzzer to beep.
...
<img src="../_static/media/chapter_6/section_5/01/media/image13.png" class="common_img" />
...
<img src="../_static/media/chapter_6/section_6/01/media/image5.png" class="common_img" />

(5) After waiting for a moment, a prompt window will appear indicating that the installation is complete. Click `“Finish”`.

<img src="../_static/media/chapter_6/section_6/01/media/image6.png" class="common_img" />

(6) After the installation is completed, click <img src="../_static/media/chapter_6/section_6/01/media/image7.png"   /> to open it.